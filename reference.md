...
Possible reasons for the error:
 ...
 1. Your `business-fn` is not a pure, referentially transparent function, [as it should be](https://github.com/klauswuestefeld/prevayler-clj/tree/master#usage). It might be running [non-deterministic code](https://stackoverflow.com/questions/17626262/java-not-deterministic).
